...
const allCourses = Object.entries(allCoursesData).map(([slug, course]) => ({
  id: slug,
  title: course.title,
...
const courseDescriptions = {
  ...
  Others:
    "Industry-specific professional tools and applications like Tally for accounting, AutoCAD for design, and more specialized software for various fields",

};

export function AllCoursesContent() {
        ...
        {filteredCourses.map((course) => (
          ...
          >
            {course.category === "Full Stack" && (
              <span className="absolute top-2 right-2 bg-green-500 text-white text-xs font-medium px-2 py-1 rounded flex items-center">
